...
public class Arm extends SubsystemBase {
    ...
    public void armMechanism(){
        ...
        telemetry.addData("Angle Motor Current Position: ", angleMotor.getCurrentPosition());
        ...
        telemetry.addData("Extending Motor Current Position: ", extendingMotor.getCurrentPosition());
    ...
    public void reset(){
        ...
        extendingMotor.setRunMode(Motor.RunMode.PositionControl);
        angleMotor.setRunMode(Motor.RunMode.PositionControl);
        extendingMotor.setPositionTolerance(0.5);
        angleMotor.setPositionCoefficient(0.5);
        extendingMotor.setPositionTolerance(50);
        angleMotor.setPositionTolerance(50);
