...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -0.33800910756855973; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.33800910756855973; // x position of the perpendicular encoder (in tick units)
    }
